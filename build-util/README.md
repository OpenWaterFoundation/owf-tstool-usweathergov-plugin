...
| **Script** | **Description** |
| -- | -- |
| `0-create-plugin-jar.bash` | Create the plugin jar file in the user's `~/.tstool/NN/plugins/owf-tstool-usweathergov-plugin` folder, used during development and before packaging the plugin for distribution. |
