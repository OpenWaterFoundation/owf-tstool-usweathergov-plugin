...
#   ./tstool/NN/plugins/owf-tstool-usweathergov-plugin/ folder for use by TSTool
...
mavenProjectFolder=${repoFolder}/owf-tstool-usweathergov-plugin
...
devBinFolder="${repoFolder}/owf-tstool-usweathergov-plugin/target/classes"
pluginsFolder="$HOME/.tstool/${tstoolMajorVersion}/plugins"
jarFolder="${pluginsFolder}/owf-tstool-usweathergov-plugin"
pluginDepFolder="${pluginsFolder}/owf-tstool-usweathergov-plugin/dep"
jarFile="${jarFolder}/owf-tstool-usweathergov-plugin-${pluginVersion}.jar"
manifestFile="${repoFolder}/owf-tstool-usweathergov-plugin/src/main/resources/META-INF/MANIFEST.MF"
