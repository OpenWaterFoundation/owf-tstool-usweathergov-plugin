...
This repository contains the Open Water Foundation TSTool United States (US) `weather.gov` web services plugin.
This plugin can be installed to enable commands that integrate TSTool with US Weather Service web services.

TSTool is part of [Colorado's Decision Support Systems (CDSS)](https://www.colorado.gov/cdss).
See the following online resources:

*   [TSTool US `weather.gov` Plugin download page](https://software.openwaterfoundation.org/tstool-usweathergov-plugin/)
*   [TSTool US `weather.gov` Plugin Documentation](https://software.openwaterfoundation.org/tstool-usweathergov-plugin/latest/doc-user/)
...
*   [US Weather.gov / Documenation / API Web Service](https://www.weather.gov/documentation/services-web-api)
  ...
  cdss-dev/                                  Recommended folder for CDSS product development.
    TSTool/                                  Recommended folder for TSTool development.
      git-repos/                             Recommended folder for TSTool product repositories.
        owf-tstool-usweathergov-plugin/      Repository working files.
          ...
          owf-tstool-usweathergov-plugin/    Maven project source code and supporting files.
...
This section explains how to add the TSTool US `weather.gov` plugin to the TSTool core development environment.
...
6.  Browse to the `cdss-dev/TSTool/git-repos/owf-tstool-usweathergov-plugin/owf-tstool-uswethergov-plugin` folder
    and ***Select Folder***.
...
9.  Right click on `owf-tstool-usweathergov-plugin` in ***Package Explorer*** or ***Project Explorer***
...
1.  Eclipse project:
    1.  The `owf-tstool-usweathergov-plugin` repository is added as a Maven project.
...
2.  Plugin jar file:
    ...
    3.  The above script relies on the `owf-tstool-usweathergov-plugin/src/main/resources/META-INF/MANIFEST.MF`
...
1.  Update the version:
    1.  Update the `src/main/java/owf-tstool-usweathergov-plugin/org/openwaterfoundation/tstool/plugin/usweathergov/PluginMeta.java` source file.
